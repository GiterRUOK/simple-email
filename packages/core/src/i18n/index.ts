...
export const zhCNMessages: SimpleMailMessages = {
  ...
  'topbar.sectionSelect': '选择节：批量复制 / 导出 / 删除 Section（⌘/Ctrl+点击节直达）',
  'topbar.sectionSelectActive': '退出选择节模式（Shift+点击可区间勾选）',
  'leftPanel.layout': '布局',
  ...
  'toast.exportSelectionOk': '已导出所选节的设计稿 JSON',
...
export const enUSMessages: SimpleMailMessages = {
  ...
  'topbar.sectionSelect': 'Select sections: batch copy / export / delete (⌘/Ctrl+click a section)',
  'topbar.sectionSelectActive': 'Exit section selection (Shift+click to select a range)',
  ...
  'sectionSelect.count': '{count} selected',
  ...
  'toast.exportSelectionOk': 'Selected sections exported as design JSON',
