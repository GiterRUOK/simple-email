...
export const zhCNMessages: SimpleMailMessages = {
  ...
  'topbar.sectionSelect': '选择节：批量复制 / 导出 / 删除 Section',
  'topbar.sectionSelectActive': '退出选择节模式',
  'leftPanel.layout': '布局',
...
export const enUSMessages: SimpleMailMessages = {
  ...
  'topbar.sectionSelect': 'Select sections: batch copy / export / delete',
  'topbar.sectionSelectActive': 'Exit section selection',
